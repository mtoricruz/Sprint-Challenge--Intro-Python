...
names_with = ['C', 'D', 'E', 'F', 'G']
c = [i.name for i in humans if i.name[0] in names_with]
print(c)
...
# The "humans" list should be unmodified. My original condition was modding list.
...
import math
h = [math.sqrt(i.age) for i in humans if i.age]
print(h)
